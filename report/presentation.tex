...
\begin{frame}{\bf NCD Overview}
  \begin{itemize}
    \item<1-> Export any (character) file from a server
    \item<2-> Client: kernel module (Linux 2.6.x+)
    \item<3-> Server: userspace daemon
    \item<4-> Project Status:
    \begin{itemize}
      \item<5-> successful implementation
      \item<5-> rough around the edges
      \item<5-> very clear focus for future work
    \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}{Related Work}
  \begin{itemize}
    ...
    \item nbd
    \item CUSE
    \item various usb networking layers
  \end{itemize}
\end{frame}
