...
\begin{frame}{\bf NCD Overview}
  \begin{itemize}
    \item<1-> Stuff
    \item<2-> Motivation: transparent remote device usage
    \item<3-> Client: kernel module (Linux 2.6.x+)
    \item<4-> Server: userspace daemon
    \item<5-> Current Project Status:
    \begin{itemize}
      \item<6-> successful implementation
      \item<6-> rough around the edges
      \item<6-> very clear focus for future work
    \end{itemize}
  \end{itemize}
\end{frame}
